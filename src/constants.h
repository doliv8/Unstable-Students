...
#ifdef USE_UNICODE
#define CARD_BORDER_HORIZONTAL BOX_DRAWING_LIGHT_HORIZONTAL
#define CARD_BORDER_VERTICAL BOX_DRAWING_LIGHT_VERTICAL
#define CARD_CORNER_UP_LEFT BOX_DRAWING_LIGHT_DOWN_AND_RIGHT
#define CARD_CORNER_UP_RIGHT BOX_DRAWING_LIGHT_DOWN_AND_LEFT
#define CARD_CORNER_DOWN_LEFT BOX_DRAWING_LIGHT_UP_AND_RIGHT
#define CARD_CORNER_DOWN_RIGHT BOX_DRAWING_LIGHT_UP_AND_LEFT
#else
#define CARD_BORDER_HORIZONTAL '-'
#define CARD_BORDER_VERTICAL '|'
#define CARD_CORNER_UP_LEFT '('
#define CARD_CORNER_UP_RIGHT ')'
#define CARD_CORNER_DOWN_LEFT '('
#define CARD_CORNER_DOWN_RIGHT ')'
#endif
